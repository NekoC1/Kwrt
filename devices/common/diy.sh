...
coremark wget-ssl curl autocore htop nano zram-swap kmod-lib-zstd kmod-tcp-bbr bash openssh-sftp-server block-mount resolveip ds-lite swconfig luci-app-diskman luci-app-aria2 luci-app-samba4 luci-app-smartdns /" include/target.mk
